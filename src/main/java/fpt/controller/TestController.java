...
public class TestController {
	...
	public ModelAndView getStatusName(Model model, HttpServletRequest request, HttpServletResponse response,
			HttpSession session) {
	...
	@RequestMapping("/log")
	public ModelAndView log(Model model, HttpServletRequest request, HttpServletResponse response,
			HttpSession session) {
